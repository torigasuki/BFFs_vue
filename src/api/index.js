...
// 공구 게시글 작성자가 종료
function fetchGroupPurchaseSelfEnd(community_name, grouppurchase_id) {
    return axios.post(`${config.baseUrl}/community/${community_name}/grouppurchase/${grouppurchase_id}/self_end/`,{},{
        headers: {
            'Authorization': `Bearer ${access_token()}`,
        }
    })
