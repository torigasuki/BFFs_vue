                ...
                <div class="list">
                            ...
                            <div class="main-box">
                                <div class="new-card-container">
                                    <div class="new-card-wrapper" v-if="!(notificationopen || bookmarkopen || communityopen || feedopen || purchaseopen)">
                                        <p v-if="userid===profile?.user.id">오른쪽에서 보고싶은 내 정보를 눌러보세요:)<br><br>내 정보 공개는 내 정보 수정에서 가능합니다!</p>
                    ...
                    <div class="posts" v-if="communityopen">
                        <div class="post-title-box">
                            ...
                            <router-link :to="`/my_community`" class="visit-button" v-if="userid===profile?.user.id">
                                <span>모아보기</span>
                        ...
                        <div class="category"> {{ profile?.nickname }} | {{ profile.region }} </div>
                            ...
                            <div class="guestbook-comment" v-if="userid===user?.id">
                                <div class="submit-box">
                                    <router-link :to="`/profile/update/${profile?.user?.id}`" class="Btn" @click="editProfile()">수정
...
export default {
    ...
    methods: {
        ...
        notificationOpen() {
            if (this.profile?.user.id !== this.userid && !this.profile.is_agreed) {
