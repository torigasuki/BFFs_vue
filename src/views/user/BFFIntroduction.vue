                ...
                <div class="list">
                    <div class="bookmark">
                        ...
                        <div class="new-card-container">
                            <p>2,30대 1인 가구를 위한 커뮤니티입니다.<br><br>오른쪽에서 보고싶은 정보를 눌러보세요:)<br><br>해당 설명의 제목을 클릭하시면 해당 사이트로 갈 수 있어요!<br><br>(로그인이 필요해요! 소셜로그인으로 간편하게 로그인 해보세요.)</p>
                        </div>
                    </div>

                    <div class="bookmark" v-if="notificationopen">
                        <router-link to="/meetai"><h3>
                        ...
                        <div class="new-card-container">
                            <p>ChatGPT-3.5 API를 활용해 만든 채팅 서비스입니다.<br><br>AI 친구에게 고민 상담💭을 해보세요!</p>
                        </div>
                    </div>

                    <div class="bookmark" v-if="feedopen">
                        <router-link :to="`/profile/${userid}`"><h3>
                        ...
                        <div class="new-card-container">
                            <p>마이페이지에서 내 프로필✨을 꾸며보세요.<br><br>가까운 지역의 친구를 만나게 될 지도?<br><br>친구의 페이지에 놀러가 방명록✍도 남겨보아요!</p>
                        </div>
                    </div>
                    
                    <div class="bookmark" v-if="bookmarkopen">
                        <router-link to="/community/create"><h3>
                        ...
                        <div class="new-card-container">
                            <p>내가 원하던 커뮤니티를 직접 생성해보세요.<br><br>서브 매니저로 친구를 등록하고 함께 만들어 나가는 커뮤니티!👩🏻‍🤝‍👩🏻<br><br>게시글과 댓글에 금지어❌ 설정까지?<br><br>매니저라면 해당 커뮤니티의 게시글 삭제도 가능하답니다:)<br><br>(생성 신청 후 승인이 필요하지만 현재는 바로 생성됩니다.)</p>
                        </div>
                    </div>

                    <div class="bookmark" v-if="communityopen">
                        <router-link to="/community/main"><h3>
                        ...
                        <div class="new-card-container">
                            <p>다양한 커뮤니티에 놀러가볼까요👀<br><br>커뮤니티 북마크⭐ 좋아요💝와 내 맘대로 글쓰기!</p>
                        </div>
                    </div>

                    <div class="bookmark" v-if="purchaseopen">
                        <router-link to="/community/main"><h3>
                        ...
                        <div class="new-card-container">
                            <p>혼자 구매하기에는 많거나 부담스러울 때!<br><br>커뮤니티 [글쓰기]의 [공구해요]에서 공구할 친구를 모집해보세요.🛒<br><br>마침 딱! 찾으시던 물건을 찾게 될 지도?</p>
                        </div>
                    </div>
