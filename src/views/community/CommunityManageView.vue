                ...
                <div class="main-container">
                    <div class="main-wrapper">
                        <div class="sub-title">
                            ...
                            <img class="input-image" :src="fetchCommunityDetail.data.imageurl" :style="{ opacity: fetchCommunityDetail.data.imageurl !== 'https://api.makebestie.com/media/' ? 1 : 0 }">
                        </div>
                        <div class="image-box">
...
.create-button::before {
    ...
    background-position: 18% 40%, 20% 31%, 30% 30%, 40% 30%, 50% 30%, 57% 30%,
      65% 30%, 80% 32%, 18% 60%, 83% 60%, 18% 70%, 25% 70%, 41% 70%, 50% 70%,
      64% 70%, 80% 71%;
}
